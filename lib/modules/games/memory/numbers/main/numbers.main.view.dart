...
import 'numbers.main.controller.dart';
import 'numbers.main.dart';

class NumbersMainPageView extends StatefulWidgetView<
    NumbersMainPage, NumbersMainPageController> {
  const NumbersMainPageView(NumbersMainPageController controller,
      {Key? key})
