...
import 'color_match.main.controller.dart';
import 'color_match.main.dart';

class ColorMatchMainPageView extends StatefulWidgetView<
    ColorMatchMainPage, ColorMatchMainPageController> {
  const ColorMatchMainPageView(ColorMatchMainPageController controller,
      {Key? key})
