...
import 'char_shuffle.main.controller.dart';
import 'char_shuffle.main.dart';

class CharShuffleMainPageView extends StatefulWidgetView<
    CharShuffleMainPage, CharShuffleMainPageController> {
  const CharShuffleMainPageView(CharShuffleMainPageController controller,
      {Key? key})
