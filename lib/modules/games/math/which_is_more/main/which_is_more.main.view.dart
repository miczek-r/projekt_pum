...
import 'which_is_more.main.controller.dart';
import 'which_is_more.main.dart';

class WhichIsMoreMainPageView extends StatefulWidgetView<
    WhichIsMoreMainPage, WhichIsMoreMainPageController> {
  const WhichIsMoreMainPageView(WhichIsMoreMainPageController controller,
      {Key? key})
